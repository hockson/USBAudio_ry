...
const roboeffect_effect_property_struct effect_property_for_robo[] = {
	...
	{ROBOEFFECT_AUTO_TUNE, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_AUTO_TUNE_PARAM_LEN, 4,
#if AUTO_TUNE_ENABLE
	...
	{ROBOEFFECT_DC_BLOCKER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_DC_BLOCKER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_DRC, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_DRC_PARAM_LEN, 4,
#if DRC_ENABLE
	...
	{ROBOEFFECT_ECHO, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_ECHO_PARAM_LEN, 4,
#if ECHO_ENABLE
	...
	{ROBOEFFECT_EQ, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_EQ_PARAM_LEN, 4,
#if EQ_ENABLE
	...
	{ROBOEFFECT_NOISE_SUPPRESSOR_EXPANDER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_NOISE_SUPPRESSOR_EXPANDER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_FREQ_SHIFTER, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_FREQ_SHIFTER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_HOWLING_SUPPRESSOR, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_HOWLING_SUPPRESSOR_PARAM_LEN, 4,
	...
	{ROBOEFFECT_NOISE_GATE, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_NOISE_GATE_PARAM_LEN, 4,
	...
	{ROBOEFFECT_PITCH_SHIFTER, ROBOEFFECT_CH_MONO_STEREO, FZ_128|FZ_256, ROBOEFFECT_PITCH_SHIFTER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_REVERB, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_REVERB_PARAM_LEN, 4,
#if REVERB_ENABLE
	...
	{ROBOEFFECT_THREE_D, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_THREE_D_PARAM_LEN, 4,
#if THREE_D_ENABLE
	...
	{ROBOEFFECT_VIRTUAL_BASS, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_VIRTUAL_BASS_PARAM_LEN, 4,
	...
	{ROBOEFFECT_VOICE_CHANGER, ROBOEFFECT_CH_MONO_STEREO, FZ_512, ROBOEFFECT_VOICE_CHANGER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_GAIN_CONTROL, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_GAIN_CONTROL_PARAM_LEN, 4,
	...
	{ROBOEFFECT_VOCAL_CUT, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_VOCAL_CUT_PARAM_LEN, 4,
#if VOCAL_CUT_ENABLE
	...
	{ROBOEFFECT_REVERB_PRO, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_REVERB_PRO_PARAM_LEN, 4,
	...
	{ROBOEFFECT_VOICE_CHANGER_PRO, ROBOEFFECT_CH_MONO, FZ_128|FZ_256, ROBOEFFECT_VOICE_CHANGER_PRO_PARAM_LEN, 4,
	...
	{ROBOEFFECT_PHASE_CONTROL, ROBOEFFECT_CH_MONO_STEREO, FZ_64|FZ_128|FZ_256, ROBOEFFECT_PHASE_CONTROL_PARAM_LEN, 4,
	...
	{ROBOEFFECT_VOCAL_REMOVER, ROBOEFFECT_CH_STEREO, FZ_128|FZ_256|FZ_512, ROBOEFFECT_VOCAL_REMOVER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_PITCH_SHIFTER_PRO, ROBOEFFECT_CH_MONO_STEREO, FZ_128|FZ_256|FZ_512, ROBOEFFECT_PITCH_SHIFTER_PRO_PARAM_LEN, 4,
	...
	{ROBOEFFECT_VIRTUAL_BASS_CLASSIC, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_VIRTUAL_BASS_CLASSIC_PARAM_LEN, 4,
	...
	{ROBOEFFECT_PCM_DELAY, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_PCM_DELAY_PARAM_LEN, 4,
#if PCM_DELAY_ENABLE
	...
	{ROBOEFFECT_HARMONIC_EXCITER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_HARMONIC_EXCITER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_CHORUS, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_CHORUS_PARAM_LEN, 4,
#if CHORUS_ENABLE
	...
	{ROBOEFFECT_AUTO_WAH, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_AUTO_WAH_PARAM_LEN, 4,
#if AUTO_WAH_ENABLE
	...
	{ROBOEFFECT_STEREO_WIDENER, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_STEREO_WIDENER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_PINGPONG, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_PINGPONG_PARAM_LEN, 4,
#if PINGPONG_ENABLE
	...
	{ROBOEFFECT_THREE_D_PLUS, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_THREE_D_PLUS_PARAM_LEN, 4,
	...
	{ROBOEFFECT_NOISE_SUPPRESSOR_BLUE, ROBOEFFECT_CH_MONO, FZ_128|FZ_256|FZ_512, ROBOEFFECT_NOISE_SUPPRESSOR_BLUE_PARAM_LEN, 4,
	...
	{ROBOEFFECT_FLANGER, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_FLANGER_PARAM_LEN, 4,
#if FLANGER_ENABLE
	...
	{ROBOEFFECT_FREQ_SHIFTER_FINE, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_FREQ_SHIFTER_FINE_PARAM_LEN, 4,
	...
	{ROBOEFFECT_OVER_DRIVE, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_OVER_DRIVE_PARAM_LEN, 4,
	...
	{ROBOEFFECT_DISTORTION_DS1, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_DISTORTION_DS1_PARAM_LEN, 4,
	...
	{ROBOEFFECT_EQ_DRC, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_EQ_DRC_PARAM_LEN, 4,
#if EQ_DRC_ENABLE
	...
	{ROBOEFFECT_AEC, ROBOEFFECT_CH_MONO, FZ_64, ROBOEFFECT_AEC_PARAM_LEN, 4,
#if AEC_ENABLE
	...
	{ROBOEFFECT_COMPANDER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_COMPANDER_PARAM_LEN, 4,
#if COMPANDER_ENABLE
	...
	{ROBOEFFECT_LOW_LEVEL_COMPRESSOR, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_LOW_LEVEL_COMPRESSOR_PARAM_LEN, 4,
	...
	{ROBOEFFECT_ENGINE_SOUND, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_ENGINE_SOUND_PARAM_LEN, 4,
	...
	{ROBOEFFECT_BIQUAD, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_BIQUAD_PARAM_LEN, 4,
#if BIQUAD_ENABLE
	...
	{ROBOEFFECT_CHORUS2, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_CHORUS2_PARAM_LEN, 4,
#if CHORUS2_ENABLE
	...
	{ROBOEFFECT_REVERB_PLATE, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_REVERB_PLATE_PARAM_LEN, 4,
	...
	{ROBOEFFECT_HOWLING_SUPPRESSOR_FINE, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_HOWLING_SUPPRESSOR_FINE_PARAM_LEN, 4,
	...
	{ROBOEFFECT_HOWLING_GUARD, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_HOWLING_GUARD_PARAM_LEN, 4,
	...
	{ROBOEFFECT_VIRTUAL_BASS_TD, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_VIRTUAL_BASS_TD_PARAM_LEN, 4,
	...
	{ROBOEFFECT_OVER_DRIVE_PLOY, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_OVER_DRIVE_PLOY_PARAM_LEN, 4,
	...
	{ROBOEFFECT_TREMOLO, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_TREMOLO_PARAM_LEN, 4,
#if TREMOLO_ENABLE
	...
	{ROBOEFFECT_BEAMFORMING, ROBOEFFECT_CH_STEREO, FZ_128, ROBOEFFECT_BEAMFORMING_PARAM_LEN, 4,
	...
	{ROBOEFFECT_VIRTUAL_SURROUND_2CH, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_VIRTUAL_SURROUND_2CH_PARAM_LEN, 4,
	...
	{ROBOEFFECT_ROBOT_TONE, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_ROBOT_TONE_PARAM_LEN, 4,
	...
	{ROBOEFFECT_PHASE_INVERTER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_PHASE_INVERTER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_FILTER_BUTTERWORTH, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_FILTER_BUTTERWORTH_PARAM_LEN, 4,
	...
	{ROBOEFFECT_DYNAMIC_EQ, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_DYNAMIC_EQ_PARAM_LEN, 4,
	...
	{ROBOEFFECT_LR_BALANCER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_LR_BALANCER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_HOWLING_SUPPRESSOR_SPECIFIED, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_HOWLING_SUPPRESSOR_SPECIFIED_PARAM_LEN, 4,
	...
	{ROBOEFFECT_DOWNMIX_2TO1, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_DOWNMIX_2TO1_PARAM_LEN, 4,
	...
	{ROBOEFFECT_UPMIX_1TO2, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_UPMIX_1TO2_PARAM_LEN, 4,
	...
	{ROBOEFFECT_CHANNEL_COMBINER, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_CHANNEL_COMBINER_PARAM_LEN, 4,
	...
	{ROBOEFFECT_CHANNEL_SELECTOR, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_CHANNEL_SELECTOR_PARAM_LEN, 4,
...
0x00, 0x03, 0x00, //protocol@0.3.0
0x02, 0x17, 0x03, //roboeffect_library@2.23.3
0x02, 0x2B, 0x02, //audio_effect_library@2.43.2
...
0x41, 0x00, //item len=65
0x02, 0x01, 0x02, //noise_suppressor_blue@2.1.2
...
/*****phase_inverter*****/
0x47, 0x00, //item len=71
0x01, 0x00, 0x00, //phase_inverter@1.0.0
0x0E, //effect name length
0x70, 0x68, 0x61, 0x73, 0x65, 0x5F, 0x69, 0x6E, 0x76, 0x65, 0x72, 0x74, 0x65, 0x72, 
0x00, //effect category
0x02, //bits width is 16/24
0x01, //input counter
...
/*****phase_inverter end*****/
/*****filter_butterworth*****/
0x8F, 0x00, //item len=143
0x01, 0x00, 0x00, //filter_butterworth@1.0.0
0x12, //effect name length
0x66, 0x69, 0x6C, 0x74, 0x65, 0x72, 0x5F, 0x62, 0x75, 0x74, 0x74, 0x65, 0x72, 0x77, 0x6F, 0x72, 0x74, 0x68, 
0x00, //effect category
0x02, //bits width is 16/24
0x01, //input counter
...
/*****dynamic_eq*****/
0x0B, 0x01, //item len=267
0x01, 0x01, 0x00, //dynamic_eq@1.1.0
0x0A, //effect name length
0x64, 0x79, 0x6E, 0x61, 0x6D, 0x69, 0x63, 0x5F, 0x65, 0x71, 
0x00, //effect category
0x02, //bits width is 16/24
0x02, //input counter
...
0x0B, //effect name length
0x6C, 0x72, 0x5F, 0x62, 0x61, 0x6C, 0x61, 0x6E, 0x63, 0x65, 0x72, 
0x00, //effect category
0x02, //bits width is 16/24
0x01, //input counter
...
0xB2, 0x02, //item len=690
0x04, 0x01, 0x01, //howling_suppressor_specified@4.1.1
0x1C, //effect name length
0x68, 0x6F, 0x77, 0x6C, 0x69, 0x6E, 0x67, 0x5F, 0x73, 0x75, 0x70, 0x70, 0x72, 0x65, 0x73, 0x73, 0x6F, 0x72, 0x5F, 0x73, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x64, 
0x00, //effect category
0x02, //bits width is 16/24
0x01, //input counter
...
{
	return sizeof(effect_property_for_display);// 13506 bytes
}
