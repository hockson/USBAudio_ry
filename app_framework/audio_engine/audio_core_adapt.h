...
#define NET_BIT_EN(Value, Index) 			(Value) |= (1<<(Index))
#define NET_BIT_DIS(Value, Index)			(Value) &= ~(1<<(Index))
#define	NET_BIT_GET(Value, Index)			(((Value) >> (Index)) & 0x01)
#define	NET_BIT_MASK(Value)					((Value) & ((1<<MaxNet) - 1))
