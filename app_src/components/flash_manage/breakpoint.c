...
const static BP_SYS_INFO sInitSysInfo =
{
	...
	{17,16,15,14,11,11,12,14,15,17},		// classic
	{11,11,12,14,16,16,14,13,11,13},		// pop
	{17,15,15,13,12,11,12,14,15,17},		// rock
	{17,18,17,12,10,14,12,13,17,16},		// jazz  dianyin
#if CUSTOM_MODEL == MODEL_S6
	{13,14,14,15,14,10,16,16,9,8},		// music
	{16,18,20,18,16,11,10,14,9,8},		// pubg
	{4,6,8,10,11,12,18,20,9,8},		// gun
#else
	...
	{12,12,12,12,12,12,12,0,0,0},		// ear eq
#endif
};
