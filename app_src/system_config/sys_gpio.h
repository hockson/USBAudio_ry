...
//****************************************************************************************
	...
	#define HDMI_CEC_SEND_IO	            TIMER5_PWM_A0_A7_A10_A22_A24_B0_B1 /*dma table配合*/
...
#define GPIO_KEY1                  GPIO_INDEX6
#endif
	 
#ifdef CFG_GPIO_KEY2_EN
#define GPIO_KEY2_PORT             A
#define GPIO_KEY2                  GPIO_INDEX7
#endif

#ifdef CFG_GPIO_KEY3_EN
#define GPIO_KEY3_PORT             A
#define GPIO_KEY3                  GPIO_INDEX9
#endif

#ifdef CFG_GPIO_KEY4_EN
#define GPIO_KEY4_PORT             A
#define GPIO_KEY4                  GPIO_INDEX10
#endif

#ifdef CFG_GPIO_KEY5_EN
#define GPIO_KEY5_PORT             A
#define GPIO_KEY5                  GPIO_INDEX15
#endif
...
#ifdef CFG_GPIO_KEY3_EN
#define GPIO_KEY3_IE               STRING_CONNECT(GPIO,GPIO_KEY3_PORT,GPIE)         
#define GPIO_KEY3_OE               STRING_CONNECT(GPIO,GPIO_KEY3_PORT,GPOE) 
#define GPIO_KEY3_PU               STRING_CONNECT(GPIO,GPIO_KEY3_PORT,GPPU) 
#define GPIO_KEY3_PD               STRING_CONNECT(GPIO,GPIO_KEY3_PORT,GPPD)         
#define GPIO_KEY3_IN               STRING_CONNECT(GPIO,GPIO_KEY3_PORT,GPIN)         
#define GPIO_KEY3_OUT              STRING_CONNECT(GPIO,GPIO_KEY3_PORT,GPOUT) 
#endif

#ifdef CFG_GPIO_KEY4_EN
#define GPIO_KEY4_IE               STRING_CONNECT(GPIO,GPIO_KEY4_PORT,GPIE)         
#define GPIO_KEY4_OE               STRING_CONNECT(GPIO,GPIO_KEY4_PORT,GPOE) 
#define GPIO_KEY4_PU               STRING_CONNECT(GPIO,GPIO_KEY4_PORT,GPPU) 
#define GPIO_KEY4_PD               STRING_CONNECT(GPIO,GPIO_KEY4_PORT,GPPD)         
#define GPIO_KEY4_IN               STRING_CONNECT(GPIO,GPIO_KEY4_PORT,GPIN)         
#define GPIO_KEY4_OUT              STRING_CONNECT(GPIO,GPIO_KEY4_PORT,GPOUT) 
#endif

#ifdef CFG_GPIO_KEY5_EN
#define GPIO_KEY5_IE               STRING_CONNECT(GPIO,GPIO_KEY5_PORT,GPIE)         
#define GPIO_KEY5_OE               STRING_CONNECT(GPIO,GPIO_KEY5_PORT,GPOE) 
#define GPIO_KEY5_PU               STRING_CONNECT(GPIO,GPIO_KEY5_PORT,GPPU) 
#define GPIO_KEY5_PD               STRING_CONNECT(GPIO,GPIO_KEY5_PORT,GPPD)         
#define GPIO_KEY5_IN               STRING_CONNECT(GPIO,GPIO_KEY5_PORT,GPIN)         
#define GPIO_KEY5_OUT              STRING_CONNECT(GPIO,GPIO_KEY5_PORT,GPOUT) 
#endif
